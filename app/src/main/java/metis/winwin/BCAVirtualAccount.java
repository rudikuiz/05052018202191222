...
public class BCAVirtualAccount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bca_virtual_account);
        ButterKnife.bind(this);
        sessionManager = new SessionManager(BCAVirtualAccount.this);
        requestQueue = Volley.newRequestQueue(BCAVirtualAccount.this);
    ...
    private void DialogForm() {
        final Dialog dialog = new Dialog(BCAVirtualAccount.this);
        LayoutInflater inflater = (LayoutInflater) BCAVirtualAccount.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    @OnClick({R.id.btBack, R.id.generate})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.btBack:
//                Intent intent = new Intent(BCAVirtualAccount.this, MainActivity.class);
