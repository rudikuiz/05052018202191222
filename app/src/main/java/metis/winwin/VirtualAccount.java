...
public class VirtualAccount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.virtual_account);
        ButterKnife.bind(this);
        sessionManager = new SessionManager(VirtualAccount.this);
        requestQueue = Volley.newRequestQueue(VirtualAccount.this);
    ...
    private void DialogForm() {
        final Dialog dialog = new Dialog(VirtualAccount.this);
        LayoutInflater inflater = (LayoutInflater) VirtualAccount.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.btBack:
//                Intent intent = new Intent(VirtualAccount.this, MainActivity.class);
