...
public class Main3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionManager = new SessionManager(Main3Activity.this);
        requestQueue = Volley.newRequestQueue(Main3Activity.this);
        Intent intent = getIntent();
        sharedPreferences = getSharedPreferences("save", Context.MODE_PRIVATE);

        ash = intent.getStringExtra("token");
    ...
    private void DialogForm() {
        ...
        LayoutInflater inflater = (LayoutInflater) Main3Activity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
