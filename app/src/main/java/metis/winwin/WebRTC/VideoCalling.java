...
public class VideoCalling extends AppCompatActivity implements AppRTCClient.SignalingEvents,
    ...
    private String toiduser, nama, foto, mode;
...
//            GooglePlayServicesUtil.getErrorDialog(e.getConnectionStatusCode(), VideoCalling.this, 0);
...
//        }
        ...
        if (bundle != null) {
            ...
            mSocket.connect();
            mSocket.emit(getString(R.string.register), new SessionManager(VideoCalling.this).getIduser(), toiduser);
        ...
        peerConnectionClient.createPeerConnectionFactory(
                VideoCalling.this, peerConnectionParameters, VideoCalling.this);
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    if (mSocket.connected()) {
                        ...
                        GlobalToast.ShowToast(VideoCalling.this, getString(R.string.disconnected));
...
//                    }).create().show();
            ...
            AndLog.ShowLog(VideoCalling.class.getSimpleName(), errorMessage);
        }
    }
    ...
    private void CallingToUser(final String roomId) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppConf.URL_CALL, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                SessionManager sess = new SessionManager(VideoCalling.this);
                Map<String, String> params = new HashMap<String, String>();
                params.put("dariid", sess.getIduser());
                params.put("keid", toiduser);
                params.put("tipe", "vcall");
                params.put("kode", roomId);
                return params;
            }
        };

        VolleyHttp.getInstance(VideoCalling.this).addToRequestQueue(stringRequest);
    }
}
