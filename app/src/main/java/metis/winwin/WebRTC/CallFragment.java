...
public class CallFragment extends Fragment {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    controlView =
        inflater.inflate(R.layout.fragment_video_call, container, false);
  ...
  public void onStart() {
    ...
    if (args != null) {
      String contactName = args.getString(VideoCalling.EXTRA_ROOMID);
      contactView.setText(contactName);
      videoCallEnabled = args.getBoolean(VideoCalling.EXTRA_VIDEO_CALL, true);
      captureSliderEnabled = videoCallEnabled
          && args.getBoolean(VideoCalling.EXTRA_VIDEO_CAPTUREQUALITYSLIDER_ENABLED, false);
    }
    if (!videoCallEnabled) {
