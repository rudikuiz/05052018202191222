...
public class AppRTCProximitySensor implements SensorEventListener {
  ...
  private AppRTCProximitySensor(Context context, Runnable sensorStateListener) {
    //AndLog.ShowLog(TAG, "AppRTCProximitySensor" + AppRTCUtils.getThreadInfo());
  ...
  public boolean start() {
    ...
    //AndLog.ShowLog(TAG, "start" + AppRTCUtils.getThreadInfo());
  ...
  public void stop() {
    checkIfCalledOnValidThread();
    //AndLog.ShowLog(TAG, "stop" + AppRTCUtils.getThreadInfo());
  ...
  public final void onAccuracyChanged(Sensor sensor, int accuracy) {
    ...
    if (accuracy == SensorManager.SENSOR_STATUS_UNRELIABLE) {
      //AndLog.ShowLog(TAG, "The values returned by this sensor cannot be trusted");
    }
  }
  ...
  public final void onSensorChanged(SensorEvent event) {
    ...
    if (distanceInCentimeters < 3) {
      //AndLog.ShowLog(TAG, "Proximity sensor => NEAR state");
      lastStateReportIsNear = true;
    } else {
      //AndLog.ShowLog(TAG, "Proximity sensor => FAR state");
    ...
    /*AndLog.ShowLog(TAG, "onSensorChanged" + AppRTCUtils.getThreadInfo() + ": "
  ...
  private void logProximitySensorInfo() {
    ...
    //AndLog.ShowLog(TAG, info.toString());
  }
