...
import metis.winwin.Fragments.Fragment2;
import metis.winwin.Fragments.Fragment3;
...
public class Bayar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionManager = new SessionManager(Bayar.this);
        loading = new OwnProgressDialog(Bayar.this);

        loading.show();

        requestQueue = Volley.newRequestQueue(Bayar.this);
    ...
    private void initView() {
        ...
        pagerAdapter.addFragments(new Fragment2(), "page2");
        pagerAdapter.addFragments(new Fragment3(), "page3");
